...
echo
echo $red"         Tool akan di install dalam waktu 5 detik"
echo $red"            harap sabar menunggu yaa kamprett :v"
sleep 1
echo '''\a
\033[32;1m                             ____
\033[32;1m                            |___ \
...
echo
echo $red"         Tool akan di install dalam waktu 5 detik"
echo $red"            harap sabar menunggu yaa kontoll :v"
sleep 1
echo '''\a
\033[33;1m                            _  _
\033[33;1m                           | || |
...
echo
echo $red"         Tool akan di install dalam waktu 5 detik"
echo $red"            harap sabar menunggu yaa bujank :v"
sleep 1
echo '''\a
\033[36;1m                             ____
\033[36;1m                            | ___|
...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  PutraOrz  "$i"                  "
echo $i""$pu"  WhatsApp:  082243xxxxx"$i"                 "
echo $i""$pu"  GMAIL   :  revoxSH3223@gmail.com"$i"       "
echo $i""$pu"  FACEBOOK:  Rela Saputra"$i"                "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Rela Saputra"
echo $ku"GMAIL    :"$i" revoxSH3223@gmail.com"
echo $ku"WhatsApp :"$i" 0822433xxxxx"
sleep 2
